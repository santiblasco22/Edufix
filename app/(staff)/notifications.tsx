      ...
      <FlatList
        ...
        ListEmptyComponent={
          <EmptyState
            ...
            subtitle="Acá vas a ver cuando se reporte un nuevo incidente en la institución."
          />
        }
        renderItem={({ item }) => (
          <TouchableOpacity
            style={[styles.item, !item.read && styles.itemUnread]}
            onPress={() => router.push(`/(staff)/incident/${item.incident_id}`)}
            activeOpacity={0.7}
          >
...
const styles = StyleSheet.create({
  ...
  unreadBadge: {
    backgroundColor: COLORS.warning, borderRadius: 100,
  ...
  itemUnread: { borderColor: COLORS.warning, backgroundColor: '#FFFDF7' },
  iconWrap: {
